...
export function CaptureEditor({ onCaptured }: { onCaptured: () => void }) {
  const { draft, updateDraft, resetDraft, draftWords, draftCharsNoSpaces, liveCharsPerMinute } = useAppState();
    ...
    <Card className="space-y-4 p-5 md:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">Write fast. Press Enter + Capture when ready.</p>
        </div>
